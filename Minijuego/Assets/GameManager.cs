...
public class GameManager : MonoBehaviour
{
    ...
    private const string NEXT_LEVEL_NAME = "Nivel2_Entrega";
...
{
    Debug.Log("¡NIVEL COMPLETADO! Has entregado la mercancía.");

    // PAUSA EL JUEGO: 
    Time.timeScale = 0f; 

    // Lógica de UI/Escena: 
    // Aquí debes añadir código para mostrar un panel de "Ganaste" 
    // o para cargar la siguiente escena de juego.
}
